...
> ### Loco.rs (Rust) + HTMX codebase containing real world examples (CRUD, auth, advanced patterns, etc) that adheres to the [RealWorld](https://github.com/gothinkster/realworld) spec and API.
...
The project uses the **SaaS starter** which includes a `User` model and authentication based on JWT.
